<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 z-[9000]">
                ...
                <div class="shrink-0 flex items-center">
                    <a id="openSidebarBtn">
                        <img src="{{ asset('ASSETS/dkp_mks.png') }}"
                            class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200 cursor-pointer">
                    </a>
                </div>
